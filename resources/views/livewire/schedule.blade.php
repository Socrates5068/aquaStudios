                                ...
                                <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                                    <div style="width: 14.28%; height: 120px"
                                        ...
                                        <div style="height: 80px;" class="overflow-y-auto mt-1">
                                            <div class="absolute top-0 right-0 mt-1 md:mt-2 mr-1 md:mr-2 inline-flex items-center justify-center rounded-full text-xs md:text-sm w-4 md:w-6 h-4 md:h-6 bg-gray-700 text-white leading-none"
                                            ...
                                            <template
                                                ...
                                                <div class="mt-1 md:px-2 py-0.5 rounded-lg md:mt-1 overflow-hidden md:border"
                                                    :class="{
                                                    ...
                                                    <a class="cursor-pointer">
                                                        <p x-text="event.event_title"
                                                            class="text-xs md:text-sm truncate md:leading-tight">
                                                        </p>
                                                    </a>
                                                </div>
                                            </template>
                ...
                {{-- <div style=" background-color: rgba(0, 0, 0, 0.8)"
                    ...
                    <div class="p-4 max-w-xl mx-auto absolute left-0 right-0 overflow-hidden mt-24">
                        ...
                        <div class="shadow w-full rounded-lg bg-white overflow-hidden block p-8">
                            ...
                            <h2 class="font-bold text-2xl mb-6 text-gray-800 border-b pb-2">Agregar detalles del evento
                            </h2>
            ...
            function app() {
                return {
                    ...
                    addEvent() {
                        ...
                        date.event_url = 'schedule/delete?event_date=' + this.event_date + '&event_title=' + this.event_title +
                        ...
                        this.events.push({
                            ...
                            event_theme: this.event_theme,
                            event_url: 'schedule/delete?event_date=' + this.event_date + '&event_title=' + this
                                .event_title + '&event_theme=' + this.event_theme,
                        });
