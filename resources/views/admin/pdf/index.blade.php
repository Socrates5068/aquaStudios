...
$dates = Report::latest('id')->first();

$orders = Order::whereBetween('created_at', [$dates->from, $dates->to])->get();
@endphp
...
<body class="font-roboto antialiased">
    ...
    <div class="container col-10">
        <div class="align-content-center text-center">
            <p style="font-size: 20px; font-weight: bold; margin-top: 25px;">Reservas realizadas entre {{$dates->from}} y {{$dates->to}}
                </p>
            <div class="form-group">
                <table class="mt-8 table table-bordered mb-5">
