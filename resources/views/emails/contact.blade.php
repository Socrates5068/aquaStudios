                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        {{-- <h1
                                            ...
                                            ¡Nuevo mensaje del formulario de contacto!</h1> --}}
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Si estás eniendo problemas con el botón "Ver estado de mi
                                                        reserva" entonces, copia y pega la siguiente dirección
                                                        en tu navegador: <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="http://aquastudios.test/orders/4"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">http://aquastudios.test/orders/4</a></span>
                                                    </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2021 AquaStudios. Todos los derechos reservados.</p>
